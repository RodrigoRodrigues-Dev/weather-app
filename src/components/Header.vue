...
<template>
  <header class="sticky top-0 bg-light-background dark:bg-dark-background shadow-lg">
    <nav class="container flex flex-col sm:flex-row justify-between items-center gap-4 text-light-text py-6">
      <div class="flex justify-center items-center dark:text-dark-text">
