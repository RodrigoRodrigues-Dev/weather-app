...
onMounted(() => {
  // Define a função callback globalmente para que a API do Google Maps a encontre
  window.vueGoogleMapsInit = initializeMap;
  loadGoogleMapsApi();
});
...
function getMapStyle(themeColors) {
  return [
    ...
    },
    {
      featureType: 'water',
      elementType: 'geometry',
      stylers: [{ color: themeColors.water }]
    },
    {
      featureType: 'landscape',
      elementType: 'geometry',
      stylers: [{ color: themeColors.backgroundSecondary }]
    },
    {
      featureType: 'road',
      elementType: 'geometry',
      stylers: [{ color: themeColors.border }, { lightness: 50 }]
    },
    {
      featureType: 'poi',
      elementType: 'geometry',
      stylers: [{ color: themeColors.poi }]
    },
    {
      featureType: 'transit',
      elementType: 'geometry',
      stylers: [{ color: themeColors.border }]
    },
    {
      featureType: 'administrative',
      elementType: 'geometry',
      stylers: [{ color: themeColors.secondaryText }]
    },
    {
      featureType: 'water',
      elementType: 'labels',
      stylers: [{ color: themeColors.highlight }]
    },
    {
      featureType: 'landscape',
      elementType: 'labels',
